...
Console.WriteLine($"Veg based menu, no coupon:{vegetarianMenu.CalculatePrice()} euro.");

vegetarianMenu = new VegetarianMenu(oneEuroCoupon);
Console.WriteLine($"Veg based menu, one euro coupon:{vegetarianMenu.CalculatePrice()} euro.");